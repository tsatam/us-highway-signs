...
})(exports.HighwaySystem || (exports.HighwaySystem = {}));
...
function UnknownSign(props) {
    return React.createElement("svg", { className: styles$1.sign, viewBox: '-512 -512 1024 1024' },
        React.createElement("rect", { className: styles$1.backdrop, x: "-512", y: "-512", width: "1024", height: "1024", rx: "64", ry: "64" }),
        React.createElement("circle", { className: styles$1.circle, cx: "0", cy: "0", r: "491" }),
        React.createElement("text", { className: styles$1.text + " " + (props.routeNumber.length > 2 ? styles$1.text3Digit : undefined), textAnchor: "middle", dominantBaseline: "middle", x: "0", y: "75" }, props.routeNumber));
}

(function (UsState) {
    UsState["MICHIGAN"] = "michigan";
})(exports.UsState || (exports.UsState = {}));
...
function MichiganStateSign(props) {
    return React.createElement("svg", { className: styles$2.sign, viewBox: '-512 -512 1024 1024' },
        React.createElement("rect", { className: styles$2.backdrop, x: "-512", y: "-512", width: "1024", height: "1024", rx: "64", ry: "64" }),
        React.createElement("rect", { className: styles$2.diamond, x: "-346", y: "-346", width: "686", height: "686" }),
        React.createElement("path", { className: styles$2.blockM, d: "M 0,0\n            m 0,-210\n            52,-52\n            0,60\n            -15,0\n            0,40\n            64,0\n            0,-40\n            -15,0\n            0,-72\n            15,0\n            0,-40\n            -50, 0\n            -52,52\n            -52,-52\n            -50,0\n            0,40\n            15,0\n            0,72\n            -15,0\n            0,40\n            64,0\n            0,-40\n            -15,0\n            0,-60\n            52,52\n            z" }),
        React.createElement("text", { className: styles$2.text + " " + (props.routeNumber.length > 2 ? styles$2.text3Digit : undefined), textAnchor: "middle", dominantBaseline: "middle", x: "0", y: "100" }, props.routeNumber));
}

function UsStateSign(props) {
    switch (props.state) {
        case exports.UsState.MICHIGAN:
            return React.createElement(MichiganStateSign, __assign({}, props));
        default:
            return React.createElement(UnknownSign, __assign({}, props));
    }
}
...
function UsHighwaySign(props) {
    ...
    return React.createElement("svg", { className: styles$3.sign, viewBox: [
            A / -2,
            B / -2,
            A,
            B
        ].join(' ') },
        React.createElement("rect", { className: styles$3.backdrop, x: A / -2, y: B / -2, width: A, height: B, rx: P, ry: P }),
        React.createElement("g", { className: styles$3.shield },
            React.createElement("path", { d: "M 0 " + ((B / -2) + N) + "\n                    a " + L + " " + L + " 0 0 0 " + K + " 0\n                    l " + M + " " + M + "\n                    a " + J + " " + J + " 0 0 0 -1 14\n                    A " + E + " " + E + " 0 0 1 " + ((A / 2) - N) + " " + ((B / 2) - (E + H)) + "\n                    a " + E + " " + E + " 0 0 1 " + -E + " " + E + "\n                    l " + -F + " 0\n                    A " + G + " " + G + " 0 0 0 0 " + ((B / 2) - N) + "\n                    z" }),
            React.createElement("path", { d: "M 0 " + ((B / -2) + N) + "\n                    a " + L + " " + L + " 0 0 1 " + -K + " 0\n                    l " + -M + " " + M + "\n                    a " + J + " " + J + " 0 0 1 1 14\n                    A " + E + " " + E + " 0 0 0 " + ((A / -2) + N) + " " + ((B / 2) - (E + H)) + "\n                    a " + E + " " + E + " 0 0 0 " + E + " " + E + "\n                    l " + F + " 0\n                    A " + G + " " + G + " 0 0 1 0 " + ((B / 2) - N) + "\n                    z" })),
        React.createElement("text", { className: styles$3.text, x: "0", y: (B / 2) - E + 4 }, props.routeNumber));
}

function RenderSign(props) {
    switch (props.system) {
        case exports.HighwaySystem.US_HIGHWAY: {
            return React.createElement(UsHighwaySign, __assign({}, props));
        }
        case exports.HighwaySystem.STATE: {
            return React.createElement(UsStateSign, __assign({}, props));
        }
        default: {
            return React.createElement(UnknownSign, __assign({}, props));
        }
...
function Sign(props) {
    return React.createElement("div", { className: styles.signWrapper },
        React.createElement(RenderSign, __assign({}, props)));
}
